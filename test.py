...
class MyTestCase(unittest.TestCase):
    def test_validateEquation(self):
        try:
            result = main.Ui_MainWindow.validateEquation(self,"x^,qn.")
            assert  result == "Invalid Function" , "should be Invalid Function"

            result = main.Ui_MainWindow.validateEquation(self,"x+fsdd2")
            assert  result == "Invalid Function" , "should be Invalid Function"

            result=main.Ui_MainWindow.validateEquation(self,"x+2")
            assert result=="x+2","Should be x+2"

            result=main.Ui_MainWindow.validateEquation(self,"")
    ...
    def test_validate_range(self):
        result = main.Ui_MainWindow.isValidRange(self, 10,100)
        assert result==True, "should be true"

        result = main.Ui_MainWindow.isValidRange(self, 100,10)
        assert result==False, "should be false"

    def test_validate_numbers(self):
        result = main.Ui_MainWindow.validateNumbers(self, "fd")
        assert result==False

        result = main.Ui_MainWindow.validateNumbers(self, "23432")
        assert result==True
